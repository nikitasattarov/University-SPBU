...
\begin{enumerate}
    ...
    \answer
        ...
        \begin{itemize}
            \item $\ds{\frac{card(A_1)}{card(\Omega)} = \frac{\sum\limits_{k = 0}^{2} (C_{13}^k) ^ 2 \cdot C_{26}^{5 - 2k}\cdot C_{47}^5}{C_{52}^{5} \cdot C_{47}^{5}}}$
            \item $\ds{ \frac{card(A_2)}{card(\Omega)} = \frac{\sum\limits_{k = 1}^{5} C_{13}^k \cdot C_{39}^{5 - k} \cdot C_{34 + k}^{5}}{C_{52}^{5} \cdot C_{47}^{5}}}$
            \item $\ds{ \frac{card(A_3)}{card(\Omega)} = \frac{\sum\limits_{k = 0}^{5} \sum\limits_{m = 0}^{5 - k} C_{13}^{k} \cdot C_{13}^m \cdot C_{26}^{5 - k - m} \cdot C_{13 - m}^{k} \cdot C_{34 + m}^{5 - k}}{C_{52}^{5} \cdot C_{47}^{5}} }$.
        \end{itemize}
